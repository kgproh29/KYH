...
def generate_blog():
    ...
    response = client.models.generate_content(
        ...
        contents='สลิงลาก ตราสิงห์โต, อวนฟ้า/อวนขี้ม้า, ด้ายปะอวน/เชือกโปลี, เชือกใยยักษ์, เชือกขี้ม้า/เชือกทิ้งซั้ง, เชือกสายมาน/เชือกลากสาย, ลูกลอย/ทุ่น/ลูกยาง, เครื่องเหล็ก/โซ่/สเก็น, ตะกร้า/ลังปลา/ถังเหลี่ยม, ตาข่ายกันนก, ตาข่ายสนามฟุตบอล, ตาข่ายสนามกอล์ฟ, ตาข่ายกันของตก นี้คือรายการสินค้าที่ผมขาย
        ช่วยเลือกสินค้ามา 1 อย่าง มาสร้างบทความที่เป็นประโยชน์ต่อกลุ่มคนที่ใช้สินค้าเหล่านี้ โดยในบทความช่วยค้นหาและวิเคราะห์คีย์เวิร์ดที่เป็นที่ต้องการสูงจากระบบ SEO ของ Google มาสร้างบทความภาษาไทยเชิงลึกที่มีความยาวประมาณ 300-500 คำ',
