...
def generate_blog():
    ...
    response = client.models.generate_content(
        ...
        contents='ค้นหาและวิเคราะห์คีย์เวิร์ดที่เป็นที่ต้องการสูงในกลุ่มสินค้า ตาข่ายอุตสาหกรรม/กีฬา (เช่น ตาข่ายกันนก สนามฟุตบอล สนามกอล์ฟ) อุปกรณ์ประมง หรืออุปกรณ์การเกษตร เช่น เชือกตงผลไม้ จากนั้นเลือกมา 1 หัวข้อที่เป็นประโยชน์ต่อกลุ่มคนที่ใช้สินค้าเหล่านี้ เช่น เจ้าของสนามกีฬา เจ้าของเรือประมง ร้านค้าปลีก หรือเกษตรกร แล้วเขียนเนื้อหาบทความภาษาไทยเชิงลึกที่มีความยาวประมาณ 300-500 คำ',
