...
def generate_blog():
    ...
    response = client.models.generate_content(
        ...
        contents='สลิงลากตราสิงห์โต อวนฟ้า อวนขี้ม้า ด้ายปะอวน เชือกโปลี เชือกใยยักษ์ เชือกขี้ม้า เชือกทิ้งซั้ง เชือกสายมาน ลูกลอย ทุ่น ลูกยาง เครื่องเหล็ก โซ่ สเก็น ตะกร้า ลังปลา ถังเหลี่ยม ตาข่ายสนามฟุตบอล ตาข่ายสนามกอล์ฟ ตาข่ายกันของตก นี้คือรายการสินค้า 21 รายการที่ผมขาย ช่วยเลือกสินค้ามา 1 อย่างจากลิสต์ทั้งหมด มาสร้างบทความที่เป็นประโยชน์ต่อกลุ่มคนที่ใช้สินค้าเหล่านี้ โดยในบทความช่วยค้นหาและวิเคราะห์คีย์เวิร์ดที่เป็นที่ต้องการสูงจากระบบ SEO ของ Google มาสร้างบทความภาษาไทยเชิงลึกที่มีความยาวประมาณ 200-300 คำ ไม่ต้องทำตัวหนา และบทความต้องมีการ tie-in ขายของร้านกังย่งเฮง',
